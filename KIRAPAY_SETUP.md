...
- **Pagination**: Proper pagination for links and transactions
- **Filtering**: Advanced filtering for transactions
- **Copy to Clipboard**: Easy copying of links and transaction hashes
...
- It's prefixed with `NEXT_PUBLIC_` to make it available in the browser
- In production, ensure your API key is properly secured
- Consider implementing server-side API calls for sensitive operations
...
This is a starter template for KiraPay API integration. Feel free to:
- Add new features
...
For KiraPay API support, please refer to the official KiraPay documentation or contact their support team.
